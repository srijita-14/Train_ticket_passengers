...
public class TicketService {
    ...
    public Map<String, Object> save(Map<String, Object> ticket) {
        Map<String, Object> rMap = jdbcTemplateOfTicket.queryForMap("insert into ticket(ticket_no,price,start_city,end_city,train_no) values(?,?,?,?,?) RETURNING ticket_no",
                Integer.parseInt((String) ticket.get("ticket_no")),
                Integer.parseInt((String) ticket.get("price")),
                ticket.get("start_city"),
                ticket.get("end_city"),
               // Integer.((String) ticket.get("booking_date")),
